    ...
    internal sealed class Configuration : DbMigrationsConfiguration<bdSupermercado>
    {
        ...
        protected override void Seed(Delphos.Models.bdSupermercado context)
        {
            ...
            context.Usuarios.AddOrUpdate(
                ...
                new Usuario { Id = 2, Nombre = "Jesus", Rut = "16186571-5", ApellidoP = "Toledo", ApellidoM = "Nazaret", Direccion = "Casa 0000", Email = "a@a.cl", Telefono = 123456789, Password = "123", CargoId = 2, Estado = "Activo", FechasCreacion = new DateTime(2020, 4, 10, 12, 30, 00) },
                new Usuario { Id = 3, Nombre = "Fernando", Rut = "16186571-2", ApellidoP = "Orellana", ApellidoM = "Cadiz", Direccion = "Casa 0000", Email = "a@a.cl", Telefono = 123456789, Password = "123", CargoId = 3, Estado = "Activo", FechasCreacion = new DateTime(2020, 3, 10, 12, 30, 00) },
                new Usuario { Id = 4, Nombre = "comercial", Rut = "16186571-k", ApellidoP = "ApellidoP", ApellidoM = "ApellidoM", Direccion = "Casa 0000", Email = "a@a.cl", Telefono = 123456789, Password = "123", CargoId = 4, Estado = "Activo", FechasCreacion = new DateTime(2020, 2, 10, 12, 30, 00) }
                );
            context.SaveChanges();
